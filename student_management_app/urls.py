...
urlpatterns = [
    ...
    # URL for Admin
    path('adminster_home/', HodViews.adminster_home, name="adminster_home"),
    ...
    path('adminster_view_attendance/', HodViews.adminster_view_attendance, name="adminster_view_attendance"),
    path('adminster_get_attendance_dates/', HodViews.adminster_get_attendance_dates, name="adminster_get_attendance_dates"),
    path('adminster_get_attendance_student/', HodViews.adminster_get_attendance_student, name="adminster_get_attendance_student"),
    path('adminster_profile/', HodViews.adminster_profile, name="adminster_profile"),
    path('adminster_profile_update/', HodViews.adminster_profile_update, name="adminster_profile_update"),
