"""
Django's settings for student_management_project project.
...
SECRET_KEY = 'django-insecure-)ymfv*%3ouh)^s49$u*(y66b85jv(p*#sigk6wq!j(6r4@x+8j'
...
#     # Needed to log in by custom User model, regardless of `allauth`
